package pom.infy.projsvc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("projsvc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("projsvc");
        ...
        config.getMapConfigs().put("pom.infy.projsvc.domain.*", initializeDomainMapConfig(jHipsterProperties));
