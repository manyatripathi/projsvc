...
import pom.infy.projsvc.web.rest.errors.BadRequestAlertException;
import pom.infy.projsvc.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "projsvcCustomer";
