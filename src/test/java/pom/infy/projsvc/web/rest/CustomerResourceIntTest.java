package pom.infy.projsvc.web.rest;

import pom.infy.projsvc.ProjsvcApp;

import pom.infy.projsvc.domain.Customer;
import pom.infy.projsvc.repository.CustomerRepository;
import pom.infy.projsvc.service.CustomerService;
import pom.infy.projsvc.web.rest.errors.ExceptionTranslator;
...
import static pom.infy.projsvc.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = ProjsvcApp.class)
